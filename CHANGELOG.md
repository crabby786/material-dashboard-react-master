...
- Solved https://github.com/createAdmin/material-dashboard-react/issues/83
### Major style changes
### Deleted components
### Added components
...
## [1.6.0] 2019-02-13
### Nice stuff
- [Added RTL support](https://github.com/createAdmin/material-dashboard-react/issues/16)
### Bug Fixing
- [Added new script for npm](https://github.com/createAdmin/material-dashboard-react/issues/69)
- Changed our buggy routing system, now it should work flawlessly, for more info, please refer to our [live docs here](https://demos.React admin.com/material-dashboard-react/#/documentation/routing-system)
- [https://github.com/createAdmin/material-dashboard-react/issues/67](https://github.com/createAdmin/material-dashboard-react/issues/67)
- [https://github.com/createAdmin/material-dashboard-react/issues/68](https://github.com/createAdmin/material-dashboard-react/issues/68)
- [https://github.com/createAdmin/material-dashboard-react/issues/66](https://github.com/createAdmin/material-dashboard-react/issues/66)
### Major style changes
...
- Github solved issues:
  - `https://github.com/createAdmin/material-dashboard-react/issues/58`
...
## [1.4.0] 2018-07-26
### Bug Fixing
- Added resize event listener for window ([see this issue here](https://github.com/createAdmin/ct-material-dashboard-pro-react/issues/40#issuecomment-406983150))
- Added issues template file
- Github solved issues:
  - https://github.com/createAdmin/material-dashboard-react/issues/49 (dropped `react-popper` in favour of `@material-ui/core/Popper`)
  - https://github.com/createAdmin/material-dashboard-react/issues/47
  - https://github.com/createAdmin/material-dashboard-react/issues/45
  - https://github.com/createAdmin/material-dashboard-react/issues/38
  - https://github.com/createAdmin/material-dashboard-react/issues/37
- Github enhancement issues:
  - https://github.com/createAdmin/material-dashboard-react/issues/47 (read the [./README.md](./README.md) file)
### Major style changes
...
- Added design from Material Dashboard by React admin
